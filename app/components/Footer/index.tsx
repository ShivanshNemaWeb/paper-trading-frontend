  ...
  return (
    <div className=" relative">
      ...
      <div className="mx-auto max-w-2xl mt-64 pb-16 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-6'>
            ...
            <h3 className='text-lightblue text-sm font-normal leading-9 mb-4 lg:mb-16'>Discover Stock & Grow, where expert brokers maximize your investments. Start today for smarter stock strategies and robust financial gains.</h3>
      ...
      <div className='py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2023 - All Rights Reserved by <Link href="https://www.stockandgrow.com" target="_blank">Stock & Grow</Link></h3>
      </div>
